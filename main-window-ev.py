...
# img = PhotoImage(file="assets/mc_title.png")
# logo =img.resize((100, 100))

# Загрузка изображения с помощью метода open()
image = Image.open("assets/mc_title.png")
image = image.resize((290, 82))
